...
assert(!app.includes("['context', 'Context Pack']") && !app.includes("['studio', 'Studio']") && !app.includes("['export', 'Export']"), 'project-bound pages are not first-level sidebar navigation');
assert(app.includes('data-action="open-project-context"') && app.includes('Context Management'), 'project cards expose project-bound context management');
assert(app.includes("if (action === 'open-project-context')") && app.includes("currentPage: 'context'"), 'context management opens the selected project context page');
