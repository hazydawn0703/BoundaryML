...
assert(styles.includes('left: 50%') && styles.includes('top: 50%') && styles.includes('translate(-50%, -50%)'), 'toast notifications are centered in the viewport');
...
assert(app.includes('function refreshSidebar()') && app.includes("if (action === 'toggle-settings-nav')") && app.includes('updateUiStateSilently((state) => {\n      state.settingsNavOpen = !state.settingsNavOpen;') && app.includes('refreshSidebar()'), 'settings nav toggles refresh only the sidebar');
