...
| Feature | Community | Pro Templates | Enterprise / Cloud |
| --- | --- | --- | --- |
| Local Demo Mode | Included | Included | Included |
| Local Server Mode | Included | Included | Included |
| Basic Workflow Spec | Included | Included | Included |
| Basic Validation Rules | Included | Included | Included |
...
| Audit Logs | Not included | Not included unless explicitly packaged | Included |
| Enterprise Rule Packs | Not included | Not included unless explicitly packaged | Included |
| Hosted Cloud | Not included | Not included unless explicitly packaged | Included |
| Self-hosted Enterprise Support | Not included | Not included | Included |
| Done-for-you Service | Paid add-on | Paid add-on | Paid service / enterprise engagement |
