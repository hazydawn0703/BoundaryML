...
async function request(path, options = {}) {
  ...
  return {
    data: envelope.data,
    meta: { requestId: envelope?.meta?.requestId, generatedAt: envelope?.meta?.generatedAt },
  };
}
...
export const workflowApi = {
  ...
  saveHistory: (projectId, payload = {}) => post(`/projects/${projectId}/workflow/history`, payload),
...
export const modelApi = {
  ...
  saveConfig: (payload) => put('/model/config', payload),
...
export const editSessionsApi = {
  list: (projectId) => get(`/projects/${projectId}/edit-sessions`),
  get: (projectId, sessionId) => get(`/projects/${projectId}/edit-sessions/${sessionId}`),
  message: (projectId, payload) => post(`/projects/${projectId}/edit-sessions/messages`, payload),
  apply: (projectId, sessionId, payload = {}) => post(`/projects/${projectId}/edit-sessions/${sessionId}/apply`, payload),
  next: (projectId, sessionId, payload = {}) => post(`/projects/${projectId}/edit-sessions/${sessionId}/next`, payload),
  reject: (projectId, sessionId) => post(`/projects/${projectId}/edit-sessions/${sessionId}/reject`, {}),
};
